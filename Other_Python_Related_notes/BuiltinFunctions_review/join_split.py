...
str_splitted = TEXT_TO_TRANSLATE.split(" ")
print(type(str_splitted))
print(str_splitted)
print(len(str_splitted))
print()
print()

for xr in repr(TEXT_TO_TRANSLATE):
    print("single_el:", repr(xr))


print(dir(__builtins__.str))
print(len(TEXT_TO_TRANSLATE))
print(TEXT_TO_TRANSLATE)
print("\u017B", "\u017C")
#new_xstr = xstr.replace('\n', ' ').replace('\r', '')
print(" ".join(TEXT_TO_TRANSLATE.split()))
