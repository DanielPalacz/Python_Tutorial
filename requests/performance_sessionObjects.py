...
# When your app:
# - makes a connection to a server using a Session, it keeps that connection around in a connection pool.
# - wants to connect to the sameserver again, it will reuse a conne from the pool rather than establishing a new one.
